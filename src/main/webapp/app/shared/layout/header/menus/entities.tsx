...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name="Entities" id="entity-menu">
    <DropdownItem tag={Link} to="/entity/user-domain">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;User Domain
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/contact">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;Contact
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/alert">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;Alert
    </DropdownItem>
    ...
    <DropdownItem tag={Link} to="/entity/emergency-service">
      <FontAwesomeIcon icon="asterisk" fixedWidth />&nbsp;Emergency Service
    </DropdownItem>
