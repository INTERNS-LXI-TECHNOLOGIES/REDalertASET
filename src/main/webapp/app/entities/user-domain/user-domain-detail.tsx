      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>{userDomainEntity.locality}</dd>
            <dt>
              <span id="mobile">Mobile</span>
            </dt>
            <dd>{userDomainEntity.mobile}</dd>
            <dt>Contacts</dt>
            <dd>
              {userDomainEntity.contacts
                ? userDomainEntity.contacts.map((val, i) => (
                    <span key={val.id}>
                      <a>{val.id}</a>
                      {i === userDomainEntity.contacts.length - 1 ? '' : ', '}
                    </span>
                  ))
                : null}
            </dd>
